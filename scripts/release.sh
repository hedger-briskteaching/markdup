...
echo "         --title \"${TAG}\" \\"
echo "         --notes \"Markdup ${TAG}. Download markdup-${VERSION}.zip and follow releases/README.md to install.\""
echo ""
echo "See .cursor/prompts/create-release.md for the full agent checklist."
