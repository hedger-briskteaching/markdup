...
export const MARKDUP_REPO_URL = "https://github.com/hedger-briskteaching/markdup";

export const MARKDUP_ISSUES_URL = "https://github.com/hedger-briskteaching/markdup/issues";
