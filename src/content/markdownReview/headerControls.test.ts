...
describe('headerControls', () => {
  it('finds collapse via chevron icon, not Expand all lines', () => {
    ...
    expect(findFileCollapseButton(region)).not.toBe(
...
describe('file collapse sync', () => {
  ...
  it('hides the rich view when the file section collapses', () => {
    ...
    expect(
      document.getElementById('rgm-markdown-review-styles')?.textContent,
    ).toContain('[data-rgm-file-collapsed] [data-rgm-rich]')
